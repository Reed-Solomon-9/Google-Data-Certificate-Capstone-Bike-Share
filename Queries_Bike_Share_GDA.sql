...
--The query can be run in full using lines 9 through 103. I included this section below for pivoting to experiment with a wider table featuring side-by-side comparisons.
